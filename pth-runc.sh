...
function set_capabilities {
	...
	capabilities="{}"
	cap=$(cat ${basedir}/config.json | jq '.process.capabilities.bounding + ["CAP_SYS_ADMIN", "CAP_NET_ADMIN", "CAP_NET_RAW", "CAP_SETGID", "CAP_SETUID", "CAP_SYS_PTRACE", "CAP_SYS_CHROOT", "CAP_MKNOD"]')
